...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.ManyToManyField(related_name='_testmodelforbiddenformanytomanyfield_field_+', to='gdpr_assist_tests_app.TargetModel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', tests.gdpr_assist_tests_app.models.UnknownCustomField(max_length=255)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='gdpr_assist_tests_app.TargetModel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', tests.gdpr_assist_tests_app.models.KnownCustomField(max_length=255)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='gdpr_assist_tests_app.TargetModel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='gdpr_assist_tests_app.TargetModel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('field', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='gdpr_assist_tests_app.TargetModel')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='target',
            field=models.OneToOneField(blank=True, null=True, on_delete=gdpr_assist.ANONYMISE(django.db.models.deletion.SET_NULL), related_name='onetoonefield', to='gdpr_assist_tests_app.PrivateTargetModel'),
        ),
        migrations.AddField(
            model_name='foreignkeytounregisteredmodel',
            name='target',
            field=models.ForeignKey(blank=True, null=True, on_delete=gdpr_assist.ANONYMISE(django.db.models.deletion.SET_NULL), related_name='foreignkey', to='gdpr_assist_tests_app.PrivateUnregisteredTargetModel'),
        ),
        migrations.AddField(
            model_name='foreignkeymodel',
            name='target',
            field=models.ForeignKey(blank=True, null=True, on_delete=gdpr_assist.ANONYMISE(django.db.models.deletion.SET_NULL), related_name='foreignkey', to='gdpr_assist_tests_app.PrivateTargetModel'),
        ),
        migrations.AddField(
            model_name='foreignkeytocannotanonymisedmodel',
            name='target',
            field=models.ForeignKey(blank=True, null=True, on_delete=gdpr_assist.ANONYMISE(django.db.models.deletion.SET_NULL), related_name='foreignkey', to='gdpr_assist_tests_app.PrivateTargetCanNotAnonymiseModel'),
        ),
    ]
